...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'byggtjansthammaro-leads' ),
				'storm'       => __( 'Storm or hail damage', 'byggtjansthammaro-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'byggtjansthammaro-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'byggtjansthammaro-leads' ),
				'not-sure'    => __( 'Vet inte än', 'byggtjansthammaro-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'byggtjansthammaro-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'byggtjansthammaro-leads' ),
				'research' => __( 'Jag kollar bara priser', 'byggtjansthammaro-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'byggtjansthammaro-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'byggtjansthammaro-leads' ),
		'contacted' => __( 'Kontaktad', 'byggtjansthammaro-leads' ),
		'quoted'    => __( 'Quote sent', 'byggtjansthammaro-leads' ),
		'won'       => __( 'Won', 'byggtjansthammaro-leads' ),
		'lost'      => __( 'Lost', 'byggtjansthammaro-leads' ),
		'spam'      => __( 'Misstänkt spam', 'byggtjansthammaro-leads' ),
	);
}
