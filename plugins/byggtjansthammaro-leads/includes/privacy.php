...
add_filter(
	...
	function ( $exporters ) {
		$exporters['byggtjansthammaro-leads'] = array(
			'exporter_friendly_name' => __( 'Quote requests', 'byggtjansthammaro-leads' ),
			'callback'               => function ( $email ) {
				$items = array();
				foreach ( npl_leads_by_email( $email ) as $lead ) {
					$data = array( array( 'name' => __( 'Received', 'byggtjansthammaro-leads' ), 'value' => $lead->post_date ) );
					...
					$items[] = array(
						'group_id'    => 'byggtjansthammaro-leads',
						'group_label' => __( 'Quote requests', 'byggtjansthammaro-leads' ),
...
add_filter(
	...
	function ( $erasers ) {
		$erasers['byggtjansthammaro-leads'] = array(
			'eraser_friendly_name' => __( 'Quote requests', 'byggtjansthammaro-leads' ),
			'callback'             => function ( $email ) {
				$removed = false;
				foreach ( npl_leads_by_email( $email ) as $lead ) {
