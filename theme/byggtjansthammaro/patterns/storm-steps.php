 ...
 * Slug: byggtjansthammaro/storm-steps
...
<div class="wp-block-group alignfull by-sec-steps" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:heading {"align":"wide"} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"className":"by-step-num"} -->
<p class="by-step-num"><?php echo (int) $i + 1; ?></p>
<!-- /wp:paragraph -->
