<?php
/**
 * Byggtjänst Hammarö AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Byggtjänst Hammarö AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through by_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'byggtjansthammaro', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'byggtjansthammaro' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'byggtjansthammaro' ) ) );

		register_block_pattern_category( 'byggtjansthammaro-sections', array( 'label' => __( 'Byggtjänst Hammarö AB sections', 'byggtjansthammaro' ) ) );
		register_block_pattern_category( 'byggtjansthammaro-pages', array( 'label' => __( 'Byggtjänst Hammarö AB page layouts', 'byggtjansthammaro' ) ) );
	}
);
